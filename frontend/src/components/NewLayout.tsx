...
const getMenuItems = (t: any): MenuItem[] => [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'stock-inventory', label: t('stock.inventory.title'), path: '/stock/inventory', icon: <Package className="h-4 w-4" /> },
      { id: 'stock-categories', label: t('stock.categories.title'), path: '/stock/categories', icon: <FileText className="h-4 w-4" /> },
      { id: 'stock-suppliers', label: t('stock.suppliers.title'), path: '/stock/suppliers', icon: <Users className="h-4 w-4" /> },
      { id: 'stock-movements', label: t('stock.movements.title'), path: '/stock/movements', icon: <FileSpreadsheet className="h-4 w-4" /> },
      { id: 'stock-purchase-orders', label: t('stock.purchaseOrders.title'), path: '/stock/purchase-orders', icon: <Receipt className="h-4 w-4" /> },
    ],
  },
  {
    id: 'hr',
    ...
    children: [
      { id: 'hr-employees', label: t('hr.employees.title'), path: '/hr/employees', icon: <Users className="h-4 w-4" /> },
      { id: 'hr-departments', label: t('hr.departments.title'), path: '/hr/departments', icon: <FileText className="h-4 w-4" /> },
      { id: 'hr-positions', label: t('hr.positions.title'), path: '/hr/positions', icon: <FileText className="h-4 w-4" /> },
      { id: 'hr-leave-requests', label: t('hr.leaveRequests.title'), path: '/hr/leave-requests', icon: <FileText className="h-4 w-4" /> },
      { id: 'hr-payroll', label: t('hr.payroll.title'), path: '/hr/payroll', icon: <Receipt className="h-4 w-4" /> },
      { id: 'hr-performance', label: t('hr.performanceReviews.title'), path: '/hr/performance-reviews', icon: <FileText className="h-4 w-4" /> },
    ],
  },
  {
    id: 'accounting',
